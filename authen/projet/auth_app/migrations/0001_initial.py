    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilisateur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('produit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.produit')),
            ],
        ),
        migrations.CreateModel(
            name='Contient',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('panier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.panier')),
                ('produit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.produit')),
            ],
        ),
        migrations.AddField(
            model_name='produit',
            name='restaurant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.restaurant'),
        ),
        migrations.CreateModel(
            name='Avis',
            fields=[
